...
extend(Analytics.prototype, {
   ...
   * has initialized.
   *
   * @param {String} method - can be one of ('track', 'identify', 'pageview', 
                                             'alias')
   * @param {Array} args - an array of arguments to the call to `method`
   * @param {Boolean} pushToFront -  whether to push call to the front of 
                                     callQueue.
   */
